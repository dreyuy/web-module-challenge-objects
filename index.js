...
function createMenuItem(name, cost, category){
    const food = {name: name, cost: cost, category: category};
    return name
}

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
console.log(createMenuItem("donuts", 1, "dessert"))
console.log(createMenuItem("iceCream", 5, "dessert"))
...
reviews.unshift({name: "Andreas", rating: 1, feedback: "terrible food"})
